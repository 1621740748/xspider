...
public class RocksJavaTest {  
	...
	private static final String dbPath = "/data/rockdb/data";  
	static {  
		RocksDB.loadLibrary();  
	}  
	RocksDB rocksDB;  
	...
	public void testCertainColumnFamily1() throws RocksDBException {  
		String table = "CertainColumnFamilyTest";  
		String key = "certainKey";  
		String value = "certainValue";  
		...
		while(i<10000000) {
			rocksDB.put(columnFamilyHandle, (key+i).getBytes(), (value+i).getBytes());  

			byte[] getValue = rocksDB.get(columnFamilyHandle, (key+i).getBytes());  
			System.out.println("get Value : " + new String(getValue));  
			i++;
		}
		Long end=System.currentTimeMillis();
		System.out.println("take times:"+(end-start));
	}  
	public static void main(String[] args) throws RocksDBException {  
		RocksJavaTest test = new RocksJavaTest();  
		//      test.testDefaultColumnFamily();  
		test.testCertainColumnFamily1();  
	}  
